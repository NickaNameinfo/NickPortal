...
export const StoreCard = () => {
  return (
    <div className="grid grid-cols-4 gap-2">
      <div className="w-100 shodow bg-gradient-to-r from-sky-600 from-11% via-green-10 via-10% to-green-400 to-95% ">
        <Card className="ps-1 Storecard p-0  ">
          <CardHeader className="pb-0 pt-3 ps-2 flex-col items-start">
            <p className="p-0 font-semibold text-base cardHeader">
              Company Name Tag
            </p>
          </CardHeader>
          <CardBody className="overflow-visible pt-2 pb-3.5 ps-2 pe-1 ">
            <div className="grid grid-cols-12">
              <div className="col-span-5">
                <Image
                  alt="Card background"
                  className="object-cover rounded-xl p-0 m-0"
                  src="https://nextui.org/images/hero-card-complete.jpeg"
                />
              </div>
              <div className="col-span-7 ps-2">
                <h2 className="font-medium text-sm cardHeader">Open :</h2>
          ...
          <CardFooter className="p-0">
            <div className="grid grid-cols-2">
              <p className=" pb-3 ps-2 font-normal text-sm tracking-tight cartfootercolor">
                Products : 150
              </p>
              <p className=" pb-3 ps-2 font-normal text-sm tracking-tight cartfootercolor">
                Near By : 15 Km
